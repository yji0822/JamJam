...
public class SchoolController extends HttpServlet {
	...
	private void actionDo(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
			 * else if(com.equals("/boardModifyView.do")) { // 공지사항 글 수정 페이지 - 진행중 service =
			 * new NoticeModifyViewService(); service.execute(request, response); viewPage =
			 * "board/noticeBoardModify.jsp"; }else if(com.equals("/boradModify.do")) { //
			 * 공지사항 글 수정 진행 - 진행중 service = new NoticeModifyService();
			 * service.execute(request, response); viewPage = "notice.do"; }
			 */
		...
		/***************** 자유게시판 ***************************/
			 ...
			 * service = new FreeBoardModifyViewService(); service.execute(request,
			 * response); viewPage = "board/freeBoardModify.jsp"; }else
			 * if(com.equals("/freeModify.do")) { // 자유게시판 글 수정 진행 - 다시 확인하기 (에러) service =
			 * new FreeBoardModifyService(); service.execute(request, response); viewPage =
			 * "free.do"; }
			 */
		// 자유게시판 답글 게시판 로직
